const dao = require("../posts/post-dao.js");
module.exports = (app) => {
  ...
  const createPost = (req, res) => {
    ...
    dao.createPost(newPost).then((insertedPost) => res.json(insertedPost));
  };
  ...
  const likePost = (req, res) => {
    ...
    dao.updatePost(req.params.id, post).then((status) => res.send(status));
  };
